...
*/
/**
*estas son las clases que contienen todas las funciones del proyecto
*/
...
class BD extends Graficos
 {
            ...
            */
			...
			/**
			*funcion que cumple con el constructor
			*@return       caracteres    retorna mysqli_connect.
			*/
             function create_connecting ()
             {/**esta funcion se encarga de crear la conexion con el seridor.*/
				include('config.php');
             ...
             {
		     $departure = "<table class='table-bordered table-striped'>
		     <thead>
		     <tr>
		     $th
		     </tr>
         ...
         /**
         *esta funcion sire para hacer el llamado de la informacion de las tablas de la base de datos.
         *@param     texto     parametro de entrada del nombre de la lista de las tablas.
         *@param     texto     parametro de entrada de la tabla de la base de datos.
         *@param     texto     parametro que contiene campo lleve primaria.
         *@param     texto     parametro que contienen los campo que va a mostrars.
         */
